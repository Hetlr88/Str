...
if ENVIRONMENT:
    ...
    MUST_JOIN = os.environ.get('MUST_JOIN', "X_XF8")
    ...
    BOT_TOKEN = "7352645964:AAHjLhEQ17cBn2xnFWLazCwA_eOeP-JRWcE"
    DATABASE_URL = "mongodb+srv://KannadaMagaa:KannadaMagaa@kannadamagaaclone.kweqbmy.mongodb.net/?retryWrites=true&w=majority"
